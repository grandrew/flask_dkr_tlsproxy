...
curl -vs -X POST -d @runtest.json http://localhost:8080/p/51.15.128.11:2376/containers/create?name=testXXX --header "Content-Type: application/json" -H "$(cat ./cert.zip.b64.header)"
